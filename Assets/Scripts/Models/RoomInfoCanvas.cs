...
public class RoomInfoCanvas : MonoBehaviour{
    ...
    void Awake()
    {
        ...
        // target.GetComponentInChildren<SpriteRenderer>().color = iconColor;
    }
    ...
    public void MouseOver()
    {
        ...
        sequence.Append(infoFrame.transform.DOScaleY(1f, 0.2f).SetEase(Ease.OutCubic));
        ...
        sequence.Append(infoFrame.transform.DOScaleX(1f, 0.2f).SetEase(Ease.OutCubic));
        sequence.Play();
    }
    ...
    void LateUpdate()
    {
		...
		rectTransform.anchoredPosition = proportionalPosition - uiOffset + Vector2.up * -26;
    }
}
